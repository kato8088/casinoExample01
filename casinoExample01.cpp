...
easter01:
        if (easterEgg01 >= 5)
        {
            switch (easterEgg01_1)
            {
            case 'm':
                ShellExecute(0, 0, L"http://goo.gl/vHgxh", 0, 0, SW_SHOW);;
            default:
                cout << "quer resgatar o dinheiro? entao insira 'm'" << endl;
                goto easter01;
            }
        }
        nota: valor maior que 5 nao detectado :( resolver dps, a solucao deve ser simples
        */
    }
    if (balance >= 1)
    {
